...
public abstract class AGestureSystem: MonoBehaviour {
    ...
    public event GestureSuccess GestureSuccessEvent;  protected void invokeGestureSuccessEvent(int index) { GestureSuccessEvent(index); }
    public event GestureBackfire GestureBackfireEvent;  protected void invokeGestureBackfireEvent(int index) { GestureBackfireEvent(index); }
    public event GestureFail GestureFailEvent;  protected void invokeGestureFailEvent() { GestureFailEvent(); }
